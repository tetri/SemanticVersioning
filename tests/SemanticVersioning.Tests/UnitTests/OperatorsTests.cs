...
namespace SemanticVersioning.Tests.UnitTests
{
    public class OperatorsTests
    {
        ...
        [InlineData("1.0.0", "2.0.0", false)]
        [InlineData("1.0.0", "1.0.0", false)]
        public void GreaterThanOperator_ComparesCorrectly(string v1, string v2, bool expected)
        {
            var version1 = new SemanticVersion(v1);
            var version2 = new SemanticVersion(v2);
        ...
        [InlineData("1.0.0", "2.0.0", true)]
        [InlineData("2.0.0", "1.0.0", false)]
        public void LessThanOrEqualOperator_ComparesCorrectly(string v1, string v2, bool expected)
        {
            var version1 = new SemanticVersion(v1);
            var version2 = new SemanticVersion(v2);
        ...
        [InlineData("2.0.0", "1.0.0", true)]
        [InlineData("1.0.0", "2.0.0", false)]
        public void GreaterThanOrEqualOperator_ComparesCorrectly(string v1, string v2, bool expected)
        {
            var version1 = new SemanticVersion(v1);
            var version2 = new SemanticVersion(v2);
